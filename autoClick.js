...
const bearer = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjoiNjZmMDI2NGZhNzVkYjBjZjYzYmY4YjAwIiwiaWF0IjoxNzI4ODY5MjU3LCJleHAiOjE3Mjg5NTU2NTcsInR5cGUiOiJhY2Nlc3MifQ._37BLjbZq6yCdqFpScILGP9PYGry4xuNfv9QzfMG5o4';
const bearerTokens = [
    bearer
];
...
function logStatistics() {
    ...
    const elapsedTimeMin = (((elapsedTime/60) % 60).toFixed(0) * 60).toFixed(0);
    let ratioWL = 'inf';
    ...
    console.log(`Tempo dall'avvio: ${elapsedHours} ore ${elapsedTimeMin} minuti ${((elapsedTime % 60).toFixed(0) * 60).toFixed(0)} secondi
